...
export default function MoveChatModal({ isOpen, onClose, conversation, projects }: MoveChatModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      ...
      <div className="relative w-full max-w-[480px] bg-zinc-50 border border-zinc-200/50 rounded-2xl shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200">
        
        {/* Header */}
        <div className="flex items-start justify-between p-6 pb-4">
          <div>
            <h2 className="text-[20px] font-semibold text-zinc-900 tracking-tight">Move chat</h2>
            <p className="text-[14px] text-zinc-500 mt-1">Select a project to move this chat into.</p>
          </div>
          <button 
            onClick={onClose}
            className="p-1.5 -mr-1.5 rounded-lg text-zinc-400 hover:text-zinc-600 hover:bg-zinc-100 transition-colors"
          >
        ...
        <div className="px-6 pb-2">
          <div className="relative group">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-zinc-400 group-focus-within:text-zinc-500 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="border border-t-0 border-zinc-200 rounded-b-xl overflow-hidden bg-white max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-200 scrollbar-track-transparent pb-1">
